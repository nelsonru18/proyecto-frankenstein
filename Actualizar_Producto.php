...
<html>
    ...
    <body>
         ...
         */ 
         ...
         $sql="SELECT * FROM salida WHERE idsalida='$ID'";
           
         ?>
             <section class="form-tablas" >
             <form action="Actualizar_Producto_Registro.php" method="POST">
                <div class="tablas">
                    <table>
                        <tr>
                            <H2 class="titulotabla">SALIDAS DE PRODUCTO</H2>                        
                            <th>Codigo</th>
                            <th>Codigo<br>Trabajador</th>
                            ...
                            ?>
                        <tr>
                            <input class="tabla2" type="hidden" value="<?php echo $row['idsalida'];?>" name="salida">
                            <td><?php echo $row['idsalida'];?></td>
                            <td><input class="tabla2" type="text" value="<?php echo $row['trabajador_idtrabajador'];?>" name="trabajador"></td>
                            <td><input class="tabla2" type="text" value="<?php echo $row['producto_id'];?>"name="producto"></td>
                            <td><input class="tabla2" type="text" value="<?php echo $row['cantidadsal'];?>"name="cantidad"></td>
